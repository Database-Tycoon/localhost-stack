...
In your GitHub repo (`Database-Tycoon/localhost-stack`):
...
3. Click **Add a new pending publisher** and fill in:
   ...
   | Repository name | `localhost-stack` |
...
### First time (or after the trusted publisher error)

The `v0.4.0` tag already exists but the workflow failed. Re-trigger it by force-pushing the tag:
...
`https://github.com/Database-Tycoon/localhost-stack/actions`
